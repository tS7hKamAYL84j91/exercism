...
describe("all-your-base", (function () {
        ...
        Jest.test("empty list", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(2, /* [] */0, 10)));
              }));
        Jest.test("single zero", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(10, /* :: */[
                                    0,
                                    /* [] */0
                                  ], 2)));
              }));
        ...
        Jest.test("first base is zero", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(0, /* [] */0, 10)));
              }));
        Jest.test("first base is negative", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(-1, /* [] */0, 10)));
              }));
        Jest.test("negative digit", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(2, /* :: */[
                                    1,
                                    /* :: */[
                                      -1,
                                      /* :: */[
        ...
        Jest.test("second base is one", (function () {
                return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(10, /* [] */0, 1)));
              }));
        ...
        return Jest.test("both bases are negative", (function () {
                      return Jest.Expect[/* toEqual */12](undefined, Jest.Expect[/* expect */0](AllYourBase$AllYourBase.rebase(-1, /* :: */[
                                          1,
                                          /* [] */0
                                        ], -1)));
                    }));
